...
test(b=100, c=200) // 330 왜 330인가요?
// 자바스크립트는 값을 순서대로 넣습니다.

// 이것을 해결하기 위해 RORO 기법이 등장합니다.
// RORO: Receive an Object, Return an Object : 객체로 받고 객체로 반환한다.
...
// 위 문제와 아래 문제를 해결하기 위해 RORO를 사용할 수 있습니다.
// mob('플레이신', 100, 200, '슬라임', '슬라임_애니', 100, 0.1)
// mob('플레이신', ... 뭐가 들어가야하지?)

// 오브젝트를 활용해서 인자값을 넣어주는 기법
function player({scene, x, y, texture, animKey, initHp, dropRate}) {
  return
}
// 아래와 같이 작성되기 때문에 문제 해결, 순서도 상관없습니다.
player({
  scene: '플레이신',
  y: 200,
  x: 100,
